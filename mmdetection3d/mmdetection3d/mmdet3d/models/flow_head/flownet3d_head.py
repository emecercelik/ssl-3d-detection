...
class FlowNet3D(nn.Module):
    ...
    def forward(self, points1, points2, features1, features2):
        ...
        new_features1_1 = self.set_upconv3(points1_2, points1, new_features1_2, features1)
        flow = self.classifier(new_features1_1)
        # params = list(self.flow_embedding.named_parameters())
        # print("params1 {}".format(params[1]))
        return flow
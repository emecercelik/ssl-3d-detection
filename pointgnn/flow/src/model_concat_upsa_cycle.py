...
import flow.src.utils.tf_util
from flow.src.utils.pointnet_util import *
...
def get_model(radius, layer, point_cloud, is_training, bn_decay=None, knn=False,
    ...
    pred_flow, end_points = get_model_flow(radius, layer, point_cloud, is_training,
                                      ...
                                      flow_module='default')
    if supervised:
        return pred_flow, None, None, end_points, None
    '''
    {'l1_indices_f1': <tf.Tensor 'sa1/layer1/QueryBallPoint:0' shape=(1, 1024, 16) dtype=int32>,
    'l1_xyz_f1': <tf.Tensor 'sa1/layer1/Squeeze:0' shape=(1, 1024, 64) dtype=float32>,
    'l1_input_f1': <tf.Tensor 'strided_slice_22:0' shape=(1, 1024, 3) dtype=float32>,
    'l2_indices_f1': <tf.Tensor 'sa1/layer2/QueryBallPoint:0' shape=(1, 256, 16) dtype=int32>,
    'l2_xyz_f1': <tf.Tensor 'sa1/layer2/Squeeze:0' shape=(1, 256, 128) dtype=float32>,
    'l2_input_f1': <tf.Tensor 'sa1/layer1/GatherPoint:0' shape=(1, 1024, 3) dtype=float32>,
    'l1_points_f2': <tf.Tensor 'sa1/layer1_1/Squeeze:0' shape=(1, 1024, 64) dtype=float32>,
    'l1_xyz_f2': <tf.Tensor 'sa1/layer1_1/QueryBallPoint:0' shape=(1, 1024, 16) dtype=int32>,
    'l1_input_f2': <tf.Tensor 'strided_slice_24:0' shape=(1, 1024, 3) dtype=float32>,
    'l2_points_f2': <tf.Tensor 'sa1/layer2_1/Squeeze:0' shape=(1, 256, 128) dtype=float32>,
    'l2_xyz_f2': <tf.Tensor 'sa1/layer2_1/QueryBallPoint:0' shape=(1, 256, 16) dtype=int32>,
    'l2_input_f2': <tf.Tensor 'sa1/layer1_1/GatherPoint:0' shape=(1, 1024, 3) dtype=float32>,
    'l2_points_f1_new': <tf.Tensor 'maxpool_diff:0' shape=(1, 256, 128) dtype=float32>,
    'l3_indices_f1': <tf.Tensor 'layer3_2/QueryBallPoint:0' shape=(1, 64, 8) dtype=int32>,
    'l3_xyz_f1': <tf.Tensor 'layer3_2/Squeeze:0' shape=(1, 64, 256) dtype=float32>,
    'l4_indices_f1': <tf.Tensor 'layer4_2/QueryBallPoint:0' shape=(1, 16, 8) dtype=int32>,
    'l4_xyz_f1': <tf.Tensor 'layer4_2/Squeeze:0' shape=(1, 16, 512) dtype=float32>,
    'l3_feat_f1': <tf.Tensor 'up_sa_layer1/Squeeze:0' shape=(1, 64, 256) dtype=float32>,
    'l2_feat_f1': <tf.Tensor 'up_sa_layer2/Squeeze:0' shape=(1, 256, 256) dtype=float32>,
    'l1_feat_f1': <tf.Tensor 'up_sa_layer3/Squeeze:0' shape=(1, 1024, 256) dtype=float32>,
    'l0_feat_f1': <tf.Tensor 'fa_layer4/Squeeze:0' shape=(1, 1024, 256) dtype=float32>,
    'net1': <tf.Tensor 'fc1/Relu:0' shape=(1, 1024, 128) dtype=float32>,
    'net': <tf.Tensor 'fc2/BiasAdd:0' shape=(1, 1024, 3) dtype=float32>}
...
def get_model_flow(radius, layer, point_cloud, is_training, bn_decay=None, knn=False, flow_module='default'):
    ...
    '''
    l1_xyz_f1 = point_cloud[:, :num_point, 0:3]
    l1_points_f1 = point_cloud[:, :num_point, 3:]
    l1_xyz_f2 = point_cloud[:, num_point:, 0:3]
    l1_points_f2 = point_cloud[:, num_point:, 3:]
    ...
    '''
    if layer == 'pointnet':
        l1_feat_f1 = pointnet_fp_module(l1_xyz_f1, l2_xyz_f1, l1_points_f1,
                                        l2_feat_f1, [256, 256], is_training,
                                        bn_decay, scope='fa_layer4')
    else:
        l1_feat_f1 = set_upconv_module(l0_xyz_f1, l1_xyz_f1, l0_points_f1,
                                       l1_feat_f1, nsample=8, radius=0.3,
                                       mlp=[128,128,256], mlp2=[256],
                                       scope='up_sa_layer4',
                                       is_training=is_training, bn_decay=bn_decay,
    ...
    # FC layers
    net = tf_util.conv1d(l1_feat_f1, 128, 1, padding='VALID', bn=True,
